-- Grant Premium Access to enea.scalper@gmail.com
...
BEGIN
    ...
    FROM users 
    WHERE email = 'enea.scalper@gmail.com';
    
    -- Check if user exists
    IF user_id_var IS NULL THEN
        RAISE NOTICE 'User with email enea.scalper@gmail.com not found. Please register first.';
        RETURN;
    END IF;
    ...
    IF existing_subscription_count > 0 THEN
        ...
        SET 
            ...
            metadata = jsonb_build_object(
                ...
                'grantedBy', 'developer',
                'grantedAt', NOW()::text,
                'reason', 'Developer access for enea.scalper@gmail.com'
            ),
            updated_at = NOW()
        WHERE user_id = user_id_var;
    ...
    RAISE NOTICE '📧 Email: enea.scalper@gmail.com';
...
WHERE u.email = 'enea.scalper@gmail.com';
